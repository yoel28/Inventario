...
@Component({
    selector: 'warehouse',
    templateUrl: 'app/warehouse/index.html',
    styleUrls: ['app/warehouse/style.css'],
    directives: [Tables]
})


export class Warehouse extends RestController implements OnInit {
    ...
    initRules()
    {
        this.rules["barCode"]={"update":false,"visible":true,"type":"text","key":"barCode","title":"Codigo de Barras","placeholder":"ingrese el codigo de barras"};
    ...
    initOptionsView()
    {
        this.viewOptions["title"] = "Almacen";
