System.register(["@angular/core", "@angular/http", "ng2-toastr/ng2-toastr", "../common/globalService", "../utils/tables/tables", 'ng2-translate/ng2-translate', "../utils/save/save", "../common/basic-configuration"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            TypeCompany = (function (_super) {
                __extends(TypeCompany, _super);
                function TypeCompany(http, toastr, myglobal, translate) {
                    _super.call(this, "TIP_COM", "/type/company/", http, toastr, myglobal, translate);
                    this.http = http;
                    this.toastr = toastr;
                ...
                TypeCompany.prototype.initRules = function () {
                ...
                TypeCompany.prototype.initRuleObject = function () {
                    this.ruleObject = {
                        'icon': 'fa fa-list',
                        "type": "text",
                        "key": "tipoProducto",
                ...
                TypeCompany.prototype.externalRules = function () {
                };
                TypeCompany.prototype.initOptions = function () {
                ...
                TypeCompany.prototype.initSearch = function () {
                ...
                TypeCompany.prototype.initParamsTable = function () {
                ...
                TypeCompany.prototype.initSaveRules = function () {
                    this.paramsSave = {
                ...
                TypeCompany.prototype.ngOnInit = function () {
                    this.initRules();
                ...
                TypeCompany.prototype.asignData = function (data) {
                ...
                ], TypeCompany.prototype, "tables", void 0);
                TypeCompany = __decorate([
                    core_1.Component({
            ...
            exports_1("TypeCompany", TypeCompany);
        }
    }
});
//# sourceMappingURL=typeCompany.js.map