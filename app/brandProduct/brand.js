System.register(["@angular/core", "@angular/http", "ng2-toastr/ng2-toastr", "../common/globalService", "../utils/tables/tables", 'ng2-translate/ng2-translate', "../utils/save/save", "../common/basic-configuration"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            BrandProduct = (function (_super) {
                __extends(BrandProduct, _super);
                function BrandProduct(http, toastr, myglobal, translate) {
                    _super.call(this, "PE", "/marcas/", http, toastr, myglobal, translate);
                    this.http = http;
                    this.toastr = toastr;
                ...
                BrandProduct.prototype.initRules = function () {
                ...
                BrandProduct.prototype.initParamsTable = function () {
                ...
                BrandProduct.prototype.initSaveRules = function () {
                    this.paramsSave = {
                ...
                BrandProduct.prototype.initOptions = function () {
                ...
                BrandProduct.prototype.externalRules = function () {
                    this.initRules();
                    this.initSearch();
                    this.initRuleObject();
                    this.initSaveRules();
                };
                BrandProduct.prototype.initRuleObject = function () {
                    this.ruleObject = {
                        'icon': 'fa fa-list',
                        "type": "text",
                        "key": "marca",
                ...
                BrandProduct.prototype.asignData = function (data) {
                ...
                ], BrandProduct.prototype, "tables", void 0);
                BrandProduct = __decorate([
                    core_1.Component({
            ...
            exports_1("BrandProduct", BrandProduct);
        }
    }
});
